...
const DashboardGrid: React.FC = () => {
  return (
    <div className="grid grid-cols-6 gap-4 p-4 pt-0 w-full bg-primary">
      {/* add each components in the gird */}
      <div className="flex justify-center col-span-4 p-4 row-span-2 border shadow-xl rounded-3xl bg-white max-h-[400px]">
        <PomodoroChart />
      </div>
